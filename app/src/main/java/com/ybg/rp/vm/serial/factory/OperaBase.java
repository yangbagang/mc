...
import com.ybg.rp.vmbase.utils.ArrayUtil;
    ...
    private class ReadThread extends Thread {
        ...
        public void run() {
            ...
            for (; readThreadisRunning && this.buf != null; SystemClock.sleep(5L)) {
                ...
                if (var1 > 0) {
                    this.rxByteArrayTemp = ArrayUtil.append(this.rxByteArrayTemp, this.buf, var1);
                } else if (this.rxByteArrayTemp != null) {
                    //rxByteArray = GMethod.ArrayAppend(rxByteArrayTemp, (byte[]) null);
                    rxByteArray = ArrayUtil.append(rxByteArray, rxByteArrayTemp);
                    this.rxByteArrayTemp = null;
                }
            }
        }
