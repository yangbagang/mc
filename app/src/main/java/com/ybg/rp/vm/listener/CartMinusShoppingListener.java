...
public class CartMinusShoppingListener implements View.OnClickListener {
    ...
    public CartMinusShoppingListener(ArrayList<GoodsInfo> cartData, Handler mHandler,
