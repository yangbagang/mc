 ...
 */
public class TestMachineActivity extends Activity {
    ...
    private void setListener() {
        ...
        ViewUtil.setListViewHeightBasedOnChildren(gv_main_list, 5);
        ...
        ViewUtil.setListViewHeightBasedOnChildren(gv_cabinet_list, 5);
